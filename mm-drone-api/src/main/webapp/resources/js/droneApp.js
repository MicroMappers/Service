$(function() {
  ...
  function fetchDroneList(){
    var requestURL = "rest/web/jsonp/getdrones"
      if (typeof indexID != 'undefined')
          requestURL = 'rest/web/jsonp/drones/after/' + indexID; //'http://gis.micromappers.org/drone/rest/web/jsonp/drones/after/'
      $.ajax({
          type: 'GET',
          url: requestURL,
          dataType: 'jsonp',
    ...
    function submitFlag() {
        ...
        if (comment == "" || comment == undefined) {
            ...
            $.post("rest/report/post", jsonData);
    ...
    function editVideo() {
       ...
       // $("#uavInfo").attr('action', "http://qcricl1linuxvm2.cloudapp.net:8081/AIDRDRONE/rest/web/update");
        $("#uavInfo").attr('action', "rest/web/update");
    }
    ...
    function submitDelete() {
        ...
        if (email && email != "") {
            ...
            $.post("rest/web/jsonp/delete/" + activeVideo.vidId + "/" + email, jsonData, function(data, response) {
    ...
    $('#newUAV').click(function() {
    	...
    	$("#uavInfo #vId").remove();
      $("#uavInfo").attr('action', "rest/web/add");
    });
