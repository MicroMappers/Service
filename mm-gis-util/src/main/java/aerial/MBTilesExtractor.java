 ...
 */
public class MBTilesExtractor {

    public static void main(String[] args)  {
        try {
            File dir = new File("/Users/jlucas/Documents/DevTest/mbutil/nepal/20");
            ...
            if (dirList !=null) {
                for (int i=0; i<dirList.length; i++) {
                    ...
                    if(xFolder.getName().indexOf(".DS_Store") == -1){
                        ...
                        String yPath = "/Users/jlucas/Documents/DevTest/mbutil/nepal/20" + File.separator + xFolder.getName();
   ...
   **/
    ...
    //http://api.tiles.mapbox.com/v4/uaviators.fjb3uy6e/168.31878662109375,-17.74345487051767,19/600x600.png?access_token=pk.eyJ1IjoidWF2aWF0b3JzIiwiYSI6IlpqZEx2UzgifQ.o6vACHfsO6CTk2yluUZwUA
        return "http://api.tiles.mapbox.com/v4/globaldirt.nharlik9/" + lng + "," + lat + ",19/800x800.png?access_token=pk.eyJ1IjoiZ2xvYmFsZGlydCIsImEiOiJYLThNUDdZIn0.xWwljeqs46AUmzNQLZDjJQ";
    ...
    private static String generateFilePath(String x, String y){
        ...
        String aTile = "https://a.tiles.mapbox.com/v4/globaldirt.nharlik9/19/" + x + "/" + y + "@2x.png?access_token=pk.eyJ1IjoiZ2xvYmFsZGlydCIsImEiOiJYLThNUDdZIn0.xWwljeqs46AUmzNQLZDjJQ";
        if(isValidURL(aTile)) {
            return aTile;
        }
        ...
        String bTile = "https://b.tiles.mapbox.com/v4/globaldirt.nharlik9/19" + x + "/" + y + "@2x.png?access_token=pk.eyJ1IjoiZ2xvYmFsZGlydCIsImEiOiJYLThNUDdZIn0.xWwljeqs46AUmzNQLZDjJQ";
