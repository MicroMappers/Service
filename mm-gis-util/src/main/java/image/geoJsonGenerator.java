    ...
    **/
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //JSONArray mmTextData = getTextClickerDBData();
            ...
            String location = "";
            String created = "";
            String source = "/Users/jlucas/Downloads/esri/imageClickerJson/nepal1.csv";
    ...
    private static JSONArray getDBData(){
        ...
        try {
            ...
            String location = "";
            String created = "";
            String source = "/Users/jlucas/Downloads/esri/imageClickerJson/nepal6.csv";
    ...
    private static JSONArray getTextClickerDBData(){
        JSONArray textGeoJsonArray = new JSONArray();
        ...
        try {
            ...
            String location = "";
            String created = "";
            String source = "/Users/jlucas/Downloads/esri/textClickerJson/nepalText8.csv";
            ...
            for (Object object : content) {
                ...
                if(indexI > 0){
                    ...
                    if(row!=null){
                        ...
                        JSONObject info = new JSONObject();
                        info.put("answer", row[2]);
                        info.put("info", row[1]);


                        textGeoJsonArray.add(info);
            ...
            csvReader.close();
            System.out.println("jsonp(" + textGeoJsonArray.toJSONString() + ");");
